      ...
      <main id="main-content">
        ...
        {view === 'investigation' ? <>
          <section className="lifecycle-summary" aria-label="Incident lifecycle" data-phase={workspace.lifecycle}>
            ...
            {(workspace.lifecycle === 'complete' || (scenario.complete && cursor >= scenario.duration)) && <div className="lifecycle-actions"><button className="text-button" onClick={() => set({ dialog: 'report' })}>Open the incident report <ArrowRight size={13} /></button><button className="text-button" onClick={() => set({ view: 'explanation' })}>Review the explanation <ArrowRight size={13} /></button></div>}
          </section>
